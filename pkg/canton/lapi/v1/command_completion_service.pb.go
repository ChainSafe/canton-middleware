...
const file_com_daml_ledger_api_v1_command_completion_service_proto_rawDesc = "" +
	...
	"\rCompletionEnd\x12,.com.daml.ledger.api.v1.CompletionEndRequest\x1a-.com.daml.ledger.api.v1.CompletionEndResponseB\x90\x01\n" +
	"\x16com.daml.ledger.api.v1B\"CommandCompletionServiceOuterClassZ9github.com/chainsafe/canton-middleware/pkg/canton/lapi/v1\xaa\x02\x16Com.Daml.Ledger.Api.V1b\x06proto3"
