...
type ArchivedEvent struct {
	...
	// The package name of the archived contract.
	// Optional
...
type ExercisedEvent struct {
	...
	// The identifier uses the package-id reference format,
	// with the package id at which the contract was created.
	//
	// Required
	TemplateId *Identifier `protobuf:"bytes,3,opt,name=template_id,json=templateId,proto3" json:"template_id,omitempty"`
	// The package name of the created contract.
	...
	// The package of the choice that was exercised, which may be different from the package
	// with which the contract was created.
	//
	// Optional
...
const file_com_daml_ledger_api_v1_event_proto_rawDesc = "" +
	...
	"B}\n" +
	"\x16com.daml.ledger.api.v1B\x0fEventOuterClassZ9github.com/chainsafe/canton-middleware/pkg/canton/lapi/v1\xaa\x02\x16Com.Daml.Ledger.Api.V1b\x06proto3"
