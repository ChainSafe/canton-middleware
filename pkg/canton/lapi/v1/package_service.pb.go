...
const file_com_daml_ledger_api_v1_package_service_proto_rawDesc = "" +
	"\n" +
	",com/daml/ledger/api/v1/package_service.proto\x12\x16com.daml.ledger.api.v1\"2\n" +
	"\x13ListPackagesRequest\x12\x1b\n" +
	"\tledger_id\x18\x01 \x01(\tR\bledgerId\"7\n" +
	...
	"\rhash_function\x18\x01 \x01(\x0e2$.com.daml.ledger.api.v1.HashFunctionR\fhashFunction\x12'\n" +
	...
	"\x0epackage_status\x18\x01 \x01(\x0e2%.com.daml.ledger.api.v1.PackageStatusR\rpackageStatus*,\n" +
	"\rPackageStatus\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\x0e\n" +
	"\n" +
	"REGISTERED\x10\x01*\x1a\n" +
	"\fHashFunction\x12\n" +
	"\n" +
	"\x06SHA256\x10\x002\xd7\x02\n" +
	"\x0ePackageService\x12i\n" +
	"\fListPackages\x12+.com.daml.ledger.api.v1.ListPackagesRequest\x1a,.com.daml.ledger.api.v1.ListPackagesResponse\x12c\n" +
	"\n" +
	"GetPackage\x12).com.daml.ledger.api.v1.GetPackageRequest\x1a*.com.daml.ledger.api.v1.GetPackageResponse\x12u\n" +
	"\x10GetPackageStatus\x12/.com.daml.ledger.api.v1.GetPackageStatusRequest\x1a0.com.daml.ledger.api.v1.GetPackageStatusResponseB\x86\x01\n" +
	"\x16com.daml.ledger.api.v1B\x18PackageServiceOuterClassZ9github.com/chainsafe/canton-middleware/pkg/canton/lapi/v1\xaa\x02\x16Com.Daml.Ledger.Api.V1b\x06proto3"

var (
	file_com_daml_ledger_api_v1_package_service_proto_rawDescOnce sync.Once
	file_com_daml_ledger_api_v1_package_service_proto_rawDescData []byte
)
...
func file_com_daml_ledger_api_v1_package_service_proto_rawDescGZIP() []byte {
	file_com_daml_ledger_api_v1_package_service_proto_rawDescOnce.Do(func() {
		file_com_daml_ledger_api_v1_package_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_daml_ledger_api_v1_package_service_proto_rawDesc), len(file_com_daml_ledger_api_v1_package_service_proto_rawDesc)))
	})
...
var file_com_daml_ledger_api_v1_package_service_proto_goTypes = []any{
...
func file_com_daml_ledger_api_v1_package_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_daml_ledger_api_v1_package_service_proto_rawDesc), len(file_com_daml_ledger_api_v1_package_service_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
