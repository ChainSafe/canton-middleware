...
const (
	CommandService_SubmitAndWait_FullMethodName                   = "/com.daml.ledger.api.v1.CommandService/SubmitAndWait"
	CommandService_SubmitAndWaitForTransactionId_FullMethodName   = "/com.daml.ledger.api.v1.CommandService/SubmitAndWaitForTransactionId"
	CommandService_SubmitAndWaitForTransaction_FullMethodName     = "/com.daml.ledger.api.v1.CommandService/SubmitAndWaitForTransaction"
	CommandService_SubmitAndWaitForTransactionTree_FullMethodName = "/com.daml.ledger.api.v1.CommandService/SubmitAndWaitForTransactionTree"
)
...
func (c *commandServiceClient) SubmitAndWaitForTransactionId(ctx context.Context, in *SubmitAndWaitRequest, opts ...grpc.CallOption) (*SubmitAndWaitForTransactionIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, CommandService_SubmitAndWaitForTransactionId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CommandService_SubmitAndWaitForTransactionId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CommandService_SubmitAndWaitForTransactionId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
