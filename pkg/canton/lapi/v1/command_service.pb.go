...
const file_com_daml_ledger_api_v1_command_service_proto_rawDesc = "" +
	...
	"\x1fSubmitAndWaitForTransactionTree\x12,.com.daml.ledger.api.v1.SubmitAndWaitRequest\x1a?.com.daml.ledger.api.v1.SubmitAndWaitForTransactionTreeResponseB\x86\x01\n" +
	"\x16com.daml.ledger.api.v1B\x18CommandServiceOuterClassZ9github.com/chainsafe/canton-middleware/pkg/canton/lapi/v1\xaa\x02\x16Com.Daml.Ledger.Api.V1b\x06proto3"
