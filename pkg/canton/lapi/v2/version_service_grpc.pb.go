...
type VersionServiceClient interface {
	...
	GetLedgerApiVersion(ctx context.Context, in *GetLedgerApiVersionRequest, opts ...grpc.CallOption) (*v1.GetLedgerApiVersionResponse, error)
}
...
func (c *versionServiceClient) GetLedgerApiVersion(ctx context.Context, in *GetLedgerApiVersionRequest, opts ...grpc.CallOption) (*v1.GetLedgerApiVersionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.GetLedgerApiVersionResponse)
...
type VersionServiceServer interface {
	// Read the Ledger API version
	GetLedgerApiVersion(context.Context, *GetLedgerApiVersionRequest) (*v1.GetLedgerApiVersionResponse, error)
...
func (UnimplementedVersionServiceServer) GetLedgerApiVersion(context.Context, *GetLedgerApiVersionRequest) (*v1.GetLedgerApiVersionResponse, error) {
