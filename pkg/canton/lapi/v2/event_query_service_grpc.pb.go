...
type EventQueryServiceClient interface {
	...
	GetEventsByContractId(ctx context.Context, in *v1.GetEventsByContractIdRequest, opts ...grpc.CallOption) (*GetEventsByContractIdResponse, error)
}
...
func (c *eventQueryServiceClient) GetEventsByContractId(ctx context.Context, in *v1.GetEventsByContractIdRequest, opts ...grpc.CallOption) (*GetEventsByContractIdResponse, error) {
...
type EventQueryServiceServer interface {
	...
	// No events will be returned for contracts that have been pruned because they
	// have already been archived before the latest pruning offset.
	GetEventsByContractId(context.Context, *v1.GetEventsByContractIdRequest) (*GetEventsByContractIdResponse, error)
...
func (UnimplementedEventQueryServiceServer) GetEventsByContractId(context.Context, *v1.GetEventsByContractIdRequest) (*GetEventsByContractIdResponse, error) {
...
func _EventQueryService_GetEventsByContractId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v1.GetEventsByContractIdRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventQueryServiceServer).GetEventsByContractId(ctx, req.(*v1.GetEventsByContractIdRequest))
	}
