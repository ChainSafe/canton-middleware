...
type SubmitAndWaitForUpdateIdResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *SubmitAndWaitForUpdateIdResponse) Reset() {
	*x = SubmitAndWaitForUpdateIdResponse{}
	mi := &file_com_daml_ledger_api_v2_command_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SubmitAndWaitForUpdateIdResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SubmitAndWaitForUpdateIdResponse) ProtoMessage() {}

func (x *SubmitAndWaitForUpdateIdResponse) ProtoReflect() protoreflect.Message {
	mi := &file_com_daml_ledger_api_v2_command_service_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SubmitAndWaitForUpdateIdResponse.ProtoReflect.Descriptor instead.
func (*SubmitAndWaitForUpdateIdResponse) Descriptor() ([]byte, []int) {
	return file_com_daml_ledger_api_v2_command_service_proto_rawDescGZIP(), []int{1}
}

func (x *SubmitAndWaitForUpdateIdResponse) GetUpdateId() string {
	if x != nil {
		return x.UpdateId
	}
	return ""
...
func (x *SubmitAndWaitForUpdateIdResponse) GetCompletionOffset() string {
	if x != nil {
...
const file_com_daml_ledger_api_v2_command_service_proto_rawDesc = "" +
	"\n" +
	",com/daml/ledger/api/v2/command_service.proto\x12\x16com.daml.ledger.api.v2\x1a%com/daml/ledger/api/v2/commands.proto\x1a(com/daml/ledger/api/v2/transaction.proto\x1a\x1bgoogle/protobuf/empty.proto\"T\n" +
	"\x14SubmitAndWaitRequest\x12<\n" +
	"\bcommands\x18\x01 \x01(\v2 .com.daml.ledger.api.v2.CommandsR\bcommands\"l\n" +
	" SubmitAndWaitForUpdateIdResponse\x12\x1b\n" +
	...
	"\vtransaction\x18\x01 \x01(\v2#.com.daml.ledger.api.v2.TransactionR\vtransaction\x12+\n" +
	"\x11completion_offset\x18\x02 \x01(\tR\x10completionOffset\"\xa1\x01\n" +
	"'SubmitAndWaitForTransactionTreeResponse\x12I\n" +
	"\vtransaction\x18\x01 \x01(\v2'.com.daml.ledger.api.v2.TransactionTreeR\vtransaction\x12+\n" +
	"\x11completion_offset\x18\x02 \x01(\tR\x10completionOffset2\x8a\x04\n" +
...
var file_com_daml_ledger_api_v2_command_service_proto_goTypes = []any{
	...
	(*SubmitAndWaitForUpdateIdResponse)(nil),        // 1: com.daml.ledger.api.v2.SubmitAndWaitForUpdateIdResponse
...
var file_com_daml_ledger_api_v2_command_service_proto_depIdxs = []int32{
	...
	0, // 4: com.daml.ledger.api.v2.CommandService.SubmitAndWaitForUpdateId:input_type -> com.daml.ledger.api.v2.SubmitAndWaitRequest
	0, // 5: com.daml.ledger.api.v2.CommandService.SubmitAndWaitForTransaction:input_type -> com.daml.ledger.api.v2.SubmitAndWaitRequest
	0, // 6: com.daml.ledger.api.v2.CommandService.SubmitAndWaitForTransactionTree:input_type -> com.daml.ledger.api.v2.SubmitAndWaitRequest
	7, // 7: com.daml.ledger.api.v2.CommandService.SubmitAndWait:output_type -> google.protobuf.Empty
	1, // 8: com.daml.ledger.api.v2.CommandService.SubmitAndWaitForUpdateId:output_type -> com.daml.ledger.api.v2.SubmitAndWaitForUpdateIdResponse
	2, // 9: com.daml.ledger.api.v2.CommandService.SubmitAndWaitForTransaction:output_type -> com.daml.ledger.api.v2.SubmitAndWaitForTransactionResponse
	3, // 10: com.daml.ledger.api.v2.CommandService.SubmitAndWaitForTransactionTree:output_type -> com.daml.ledger.api.v2.SubmitAndWaitForTransactionTreeResponse
