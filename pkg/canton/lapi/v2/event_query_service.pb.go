...
const file_com_daml_ledger_api_v2_event_query_service_proto_rawDesc = "" +
	"\n" +
	"0com/daml/ledger/api/v2/event_query_service.proto\x12\x16com.daml.ledger.api.v2\x1a\"com/daml/ledger/api/v2/event.proto\x1a/com/daml/ledger/api/v2/transaction_filter.proto\"\x87\x01\n" +
	"\x1cGetEventsByContractIdRequest\x12\x1f\n" +
	"\vcontract_id\x18\x01 \x01(\tR\n" +
	"contractId\x12F\n" +
	"\fevent_format\x18\x02 \x01(\v2#.com.daml.ledger.api.v2.EventFormatR\veventFormat\"\x98\x01\n" +
