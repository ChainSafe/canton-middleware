...
func (x *Completion) GetTraceContext() *v1.TraceContext {
	if x != nil {
...
const file_com_daml_ledger_api_v2_completion_proto_rawDesc = "" +
	"\n" +
	"'com/daml/ledger/api/v2/completion.proto\x12\x16com.daml.ledger.api.v2\x1a*com/daml/ledger/api/v1/trace_context.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x17google/rpc/status.proto\"\xc3\x03\n" +
	"\n" +
	"Completion\x12\x1d\n" +
	"\n" +
...
var file_com_daml_ledger_api_v2_completion_proto_depIdxs = []int32{
	...
	3, // 2: com.daml.ledger.api.v2.Completion.trace_context:type_name -> com.daml.ledger.api.v1.TraceContext
