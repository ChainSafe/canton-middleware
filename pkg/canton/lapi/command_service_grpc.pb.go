...
const (
	...
	CommandService_SubmitAndWaitForUpdateId_FullMethodName        = "/com.daml.ledger.api.v2.CommandService/SubmitAndWaitForUpdateId"
...
type CommandServiceClient interface {
	...
	// Propagates the gRPC error of failed submissions including Daml interpretation errors.
	SubmitAndWaitForUpdateId(ctx context.Context, in *SubmitAndWaitRequest, opts ...grpc.CallOption) (*SubmitAndWaitForUpdateIdResponse, error)
...
func (c *commandServiceClient) SubmitAndWaitForUpdateId(ctx context.Context, in *SubmitAndWaitRequest, opts ...grpc.CallOption) (*SubmitAndWaitForUpdateIdResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SubmitAndWaitForUpdateIdResponse)
	err := c.cc.Invoke(ctx, CommandService_SubmitAndWaitForUpdateId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CommandServiceServer interface {
	...
	// Submits a single composite command, waits for its result, and returns the update id.
	// Propagates the gRPC error of failed submissions including Daml interpretation errors.
	SubmitAndWaitForUpdateId(context.Context, *SubmitAndWaitRequest) (*SubmitAndWaitForUpdateIdResponse, error)
	// Submits a single composite command, waits for its result, and returns the transaction.
	// Propagates the gRPC error of failed submissions including Daml interpretation errors.
...
func (UnimplementedCommandServiceServer) SubmitAndWaitForUpdateId(context.Context, *SubmitAndWaitRequest) (*SubmitAndWaitForUpdateIdResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SubmitAndWaitForUpdateId not implemented")
}
...
func _CommandService_SubmitAndWaitForUpdateId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SubmitAndWaitRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommandServiceServer).SubmitAndWaitForUpdateId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CommandService_SubmitAndWaitForUpdateId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommandServiceServer).SubmitAndWaitForUpdateId(ctx, req.(*SubmitAndWaitRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CommandService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SubmitAndWaitForUpdateId",
			Handler:    _CommandService_SubmitAndWaitForUpdateId_Handler,
		},
		{
