...
type PackageServiceClient interface {
	...
	ListPackages(ctx context.Context, in *ListPackagesRequest, opts ...grpc.CallOption) (*v1.ListPackagesResponse, error)
	// Returns the contents of a single package.
	GetPackage(ctx context.Context, in *GetPackageRequest, opts ...grpc.CallOption) (*v1.GetPackageResponse, error)
	// Returns the status of a single package.
	GetPackageStatus(ctx context.Context, in *GetPackageStatusRequest, opts ...grpc.CallOption) (*v1.GetPackageStatusResponse, error)
}
...
func (c *packageServiceClient) ListPackages(ctx context.Context, in *ListPackagesRequest, opts ...grpc.CallOption) (*v1.ListPackagesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.ListPackagesResponse)
...
func (c *packageServiceClient) GetPackage(ctx context.Context, in *GetPackageRequest, opts ...grpc.CallOption) (*v1.GetPackageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *packageServiceClient) GetPackageStatus(ctx context.Context, in *GetPackageStatusRequest, opts ...grpc.CallOption) (*v1.GetPackageStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.GetPackageStatusResponse)
...
type PackageServiceServer interface {
	// Returns the identifiers of all supported packages.
	ListPackages(context.Context, *ListPackagesRequest) (*v1.ListPackagesResponse, error)
	// Returns the contents of a single package.
	GetPackage(context.Context, *GetPackageRequest) (*v1.GetPackageResponse, error)
	// Returns the status of a single package.
	GetPackageStatus(context.Context, *GetPackageStatusRequest) (*v1.GetPackageStatusResponse, error)
...
func (UnimplementedPackageServiceServer) ListPackages(context.Context, *ListPackagesRequest) (*v1.ListPackagesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListPackages not implemented")
}
func (UnimplementedPackageServiceServer) GetPackage(context.Context, *GetPackageRequest) (*v1.GetPackageResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPackage not implemented")
}
func (UnimplementedPackageServiceServer) GetPackageStatus(context.Context, *GetPackageStatusRequest) (*v1.GetPackageStatusResponse, error) {
