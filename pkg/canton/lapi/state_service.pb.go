...
const (
	ParticipantPermission_Submission ParticipantPermission = 0
	// participant can only confirm transactions
	ParticipantPermission_Confirmation ParticipantPermission = 1
	// participant can only observe transactions
	ParticipantPermission_Observation ParticipantPermission = 2
)
...
type GetActiveContractsRequest struct {
	...
	// Optional
	ActiveAtOffset string `protobuf:"bytes,3,opt,name=active_at_offset,json=activeAtOffset,proto3" json:"active_at_offset,omitempty"`
...
func (x *ActiveContract) GetCreatedEvent() *v1.CreatedEvent {
	if x != nil {
...
func (x *IncompleteUnassigned) GetCreatedEvent() *v1.CreatedEvent {
	if x != nil {
		return x.CreatedEvent
	}
	return nil
...
type GetLedgerEndResponse struct {
	...
	Offset        *ParticipantOffset `protobuf:"bytes,1,opt,name=offset,proto3" json:"offset,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetLedgerEndResponse) GetOffset() *ParticipantOffset {
	if x != nil {
		return x.Offset
	}
	return nil
...
type GetLatestPrunedOffsetsResponse struct {
	...
	ParticipantPrunedUpToInclusive *ParticipantOffset `protobuf:"bytes,1,opt,name=participant_pruned_up_to_inclusive,json=participantPrunedUpToInclusive,proto3" json:"participant_pruned_up_to_inclusive,omitempty"`
	...
	AllDivulgedContractsPrunedUpToInclusive *ParticipantOffset `protobuf:"bytes,2,opt,name=all_divulged_contracts_pruned_up_to_inclusive,json=allDivulgedContractsPrunedUpToInclusive,proto3" json:"all_divulged_contracts_pruned_up_to_inclusive,omitempty"`
	unknownFields                           protoimpl.UnknownFields
	sizeCache                               protoimpl.SizeCache
}
...
func (x *GetLatestPrunedOffsetsResponse) GetParticipantPrunedUpToInclusive() *ParticipantOffset {
	if x != nil {
...
func (x *GetLatestPrunedOffsetsResponse) GetAllDivulgedContractsPrunedUpToInclusive() *ParticipantOffset {
	if x != nil {
...
func (x *GetConnectedDomainsResponse_ConnectedDomain) GetPermission() ParticipantPermission {
	...
	return ParticipantPermission_Submission
}
...
const file_com_daml_ledger_api_v2_state_service_proto_rawDesc = "" +
	"\n" +
	"*com/daml/ledger/api/v2/state_service.proto\x12\x16com.daml.ledger.api.v2\x1a\"com/daml/ledger/api/v1/event.proto\x1a/com/daml/ledger/api/v2/participant_offset.proto\x1a)com/daml/ledger/api/v2/reassignment.proto\x1a/com/daml/ledger/api/v2/transaction_filter.proto\"\xa2\x01\n" +
	...
	"\x10active_at_offset\x18\x03 \x01(\tR\x0eactiveAtOffset\"\xfe\x02\n" +
	...
	"\rcreated_event\x18\x01 \x01(\v2$.com.daml.ledger.api.v1.CreatedEventR\fcreatedEvent\x12R\n" +
	...
	"\x0eassigned_event\x18\x01 \x01(\v2%.com.daml.ledger.api.v2.AssignedEventR\rassignedEvent\"2\n" +
	"\x1aGetConnectedDomainsRequest\x12\x14\n" +
	"\x05party\x18\x01 \x01(\tR\x05party\"\xb2\x02\n" +
	...
	"permission\"\x15\n" +
	"\x13GetLedgerEndRequest\"Y\n" +
	"\x14GetLedgerEndResponse\x12A\n" +
	"\x06offset\x18\x01 \x01(\v2).com.daml.ledger.api.v2.ParticipantOffsetR\x06offset\"\x1f\n" +
	"\x1dGetLatestPrunedOffsetsRequest\"\xa3\x02\n" +
	"\x1eGetLatestPrunedOffsetsResponse\x12u\n" +
	"\"participant_pruned_up_to_inclusive\x18\x01 \x01(\v2).com.daml.ledger.api.v2.ParticipantOffsetR\x1eparticipantPrunedUpToInclusive\x12\x89\x01\n" +
	"-all_divulged_contracts_pruned_up_to_inclusive\x18\x02 \x01(\v2).com.daml.ledger.api.v2.ParticipantOffsetR'allDivulgedContractsPrunedUpToInclusive*J\n" +
	"\x15ParticipantPermission\x12\x0e\n" +
	"\n" +
	"Submission\x10\x00\x12\x10\n" +
	"\fConfirmation\x10\x01\x12\x0f\n" +
	"\vObservation\x10\x022\x82\x04\n" +
	"\fStateService\x12}\n" +
...
var file_com_daml_ledger_api_v2_state_service_proto_goTypes = []any{
	...
	(*v1.CreatedEvent)(nil),                             // 14: com.daml.ledger.api.v1.CreatedEvent
	(*UnassignedEvent)(nil),                             // 15: com.daml.ledger.api.v2.UnassignedEvent
	(*AssignedEvent)(nil),                               // 16: com.daml.ledger.api.v2.AssignedEvent
	(*ParticipantOffset)(nil),                           // 17: com.daml.ledger.api.v2.ParticipantOffset
}
var file_com_daml_ledger_api_v2_state_service_proto_depIdxs = []int32{
	...
	14, // 4: com.daml.ledger.api.v2.ActiveContract.created_event:type_name -> com.daml.ledger.api.v1.CreatedEvent
	14, // 5: com.daml.ledger.api.v2.IncompleteUnassigned.created_event:type_name -> com.daml.ledger.api.v1.CreatedEvent
	...
	17, // 9: com.daml.ledger.api.v2.GetLedgerEndResponse.offset:type_name -> com.daml.ledger.api.v2.ParticipantOffset
	17, // 10: com.daml.ledger.api.v2.GetLatestPrunedOffsetsResponse.participant_pruned_up_to_inclusive:type_name -> com.daml.ledger.api.v2.ParticipantOffset
	17, // 11: com.daml.ledger.api.v2.GetLatestPrunedOffsetsResponse.all_divulged_contracts_pruned_up_to_inclusive:type_name -> com.daml.ledger.api.v2.ParticipantOffset
	0,  // 12: com.daml.ledger.api.v2.GetConnectedDomainsResponse.ConnectedDomain.permission:type_name -> com.daml.ledger.api.v2.ParticipantPermission
	1,  // 13: com.daml.ledger.api.v2.StateService.GetActiveContracts:input_type -> com.daml.ledger.api.v2.GetActiveContractsRequest
	6,  // 14: com.daml.ledger.api.v2.StateService.GetConnectedDomains:input_type -> com.daml.ledger.api.v2.GetConnectedDomainsRequest
	8,  // 15: com.daml.ledger.api.v2.StateService.GetLedgerEnd:input_type -> com.daml.ledger.api.v2.GetLedgerEndRequest
	10, // 16: com.daml.ledger.api.v2.StateService.GetLatestPrunedOffsets:input_type -> com.daml.ledger.api.v2.GetLatestPrunedOffsetsRequest
	2,  // 17: com.daml.ledger.api.v2.StateService.GetActiveContracts:output_type -> com.daml.ledger.api.v2.GetActiveContractsResponse
	7,  // 18: com.daml.ledger.api.v2.StateService.GetConnectedDomains:output_type -> com.daml.ledger.api.v2.GetConnectedDomainsResponse
	9,  // 19: com.daml.ledger.api.v2.StateService.GetLedgerEnd:output_type -> com.daml.ledger.api.v2.GetLedgerEndResponse
	11, // 20: com.daml.ledger.api.v2.StateService.GetLatestPrunedOffsets:output_type -> com.daml.ledger.api.v2.GetLatestPrunedOffsetsResponse
