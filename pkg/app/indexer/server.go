...
func (s *Server) Run() error {
	...
	router := newRouter(svc, httpMetrics, cfg.Monitoring.HealthCheckURL, logger)
...
func newRouter(svc indexerservice.Service, metrics *apphttp.HTTPMetrics, healthPath string, logger *zap.Logger) http.Handler {
	r := chi.NewRouter()
