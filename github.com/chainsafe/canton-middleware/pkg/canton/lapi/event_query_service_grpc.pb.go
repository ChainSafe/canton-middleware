...
const (
	EventQueryService_GetEventsByContractId_FullMethodName  = "/com.daml.ledger.api.v1.EventQueryService/GetEventsByContractId"
	EventQueryService_GetEventsByContractKey_FullMethodName = "/com.daml.ledger.api.v1.EventQueryService/GetEventsByContractKey"
)
...
func (c *eventQueryServiceClient) GetEventsByContractKey(ctx context.Context, in *GetEventsByContractKeyRequest, opts ...grpc.CallOption) (*GetEventsByContractKeyResponse, error) {
	...
	err := c.cc.Invoke(ctx, EventQueryService_GetEventsByContractKey_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _EventQueryService_GetEventsByContractKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EventQueryService_GetEventsByContractKey_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
