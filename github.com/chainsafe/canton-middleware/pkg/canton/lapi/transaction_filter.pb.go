...
const file_com_daml_ledger_api_v1_transaction_filter_proto_rawDesc = "" +
	...
	"templateId\x12;\n" +
	"\x1ainclude_created_event_blob\x18\x02 \x01(\bR\x17includeCreatedEventBlobB\x86\x01\n" +
	"\x16com.daml.ledger.api.v1B\x1bTransactionFilterOuterClassZ6github.com/chainsafe/canton-middleware/pkg/canton/lapi\xaa\x02\x16Com.Daml.Ledger.Api.V1b\x06proto3"
