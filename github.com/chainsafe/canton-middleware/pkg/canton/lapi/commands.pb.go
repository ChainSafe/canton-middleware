...
const file_com_daml_ledger_api_v1_commands_proto_rawDesc = "" +
	...
	"\vtemplate_id\x18\x01 \x01(\v2\".com.daml.ledger.api.v1.IdentifierR\n" +
	"templateId\x12@\n" +
	"\fcontract_key\x18\x02 \x01(\v2\x1d.com.daml.ledger.api.v1.ValueR\vcontractKeyB}\n" +
	"\x16com.daml.ledger.api.v1B\x12CommandsOuterClassZ6github.com/chainsafe/canton-middleware/pkg/canton/lapi\xaa\x02\x16Com.Daml.Ledger.Api.V1b\x06proto3"
